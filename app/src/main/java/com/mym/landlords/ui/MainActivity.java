...
//		Log.d(LOG_TAG, "human cards:"+list.size());
    ...
    private void showGameOverDialog(boolean humanWin) {
		...
		ImageButton restart = (ImageButton) view.findViewById(R.id.restart);
		ImageButton exitGame = (ImageButton) view.findViewById(R.id.exitGame);
